...
/**
 * This class represents the assembly instruction for the "ior"-command. It calcluates the bitwise disjunction of the two values on top of the stack.
 * @author Tobias Kahse <tobias.kahse@outlook.com>
 * @author Frank Steiler <frank@steiler.eu>
 */
public class IOR extends Command {
