...
/**
 * This class represents the assembly instruction for the "if cmple"-command. It checks whether second uppermost value on the stack is less than or equal to the first value on the stack. Go to the specified label in case of a successful comparison.
...
public class IF_ICMPLE extends Command {
    ...
    /**
     * Default initialization of the assembly instruction for the "if cmple"-command.
