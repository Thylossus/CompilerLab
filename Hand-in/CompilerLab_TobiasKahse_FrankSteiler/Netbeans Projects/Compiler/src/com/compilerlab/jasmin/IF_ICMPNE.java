...
/**
 * This class represents the assembly instruction for the "if cmpne"-command. It check whether the value on top of the stack differs from the next one. Go to the specified label in case of a successful comparison.
...
public class IF_ICMPNE extends Command {
    ...
    /**
     * Default initialization of the assembly instruction for the "if cmpne"-command.
