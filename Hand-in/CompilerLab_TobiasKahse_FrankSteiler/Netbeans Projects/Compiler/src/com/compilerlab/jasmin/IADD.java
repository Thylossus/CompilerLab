...
/**
 * This class represents the assembly instruction for the "iadd"-command. It adds the two values on the top of the stack and pushes the result onto the stack.
 * @author Tobias Kahse <tobias.kahse@outlook.com>
 * @author Frank Steiler <frank@steiler.eu>
 */
public class IADD extends Command {
