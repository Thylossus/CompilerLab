...
/**
 * This class represents the assembly instruction for the "println"-command with an boolean argument (accepted as a string). Requires that an System.out object is on the stack.
