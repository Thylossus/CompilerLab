...
/**
 * This class represents the quotient-expression "'left' / 'right'".
...
public class Quotient extends IntExpression {
    ...
    /**
     * Default initialization of the quotient-expression.
     * @param localVariables The local variables hash map.
     * @param left The expression on the left of the slash.
     * @param right The expression on the right of the slash.
     */
    ...
    public List<Command> compile() 
    {
        ...
        //Expression on the left of the slash evaluated first
        commands.addAll(this.left.compile());
        //Expression on the right of the slash evaluated second
        commands.addAll(this.right.compile());

        //Result gets divided third
