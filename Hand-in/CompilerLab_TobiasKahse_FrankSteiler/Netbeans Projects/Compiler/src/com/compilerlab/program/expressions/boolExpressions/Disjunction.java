...
/**
 * This class represents the  boolean expression OR: "'left' || 'right'".
...
public class Disjunction extends BoolExpression {
    ...
    /**
     * Default initialization of the OR-expression.
     * @param localVariables The local variables hash map.
     * @param left The expression on the left of the OR sign.
     * @param right The expression in the right of the OR sign.
     */
