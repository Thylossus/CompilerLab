...
/**
 * This class represents the  boolean expression bigger-equals: "'left' >= 'right'".
...
public class GreaterEqual extends BoolExpression {
    ...
    /**
     * Default initialization of the bigger-equals-expression.
     * @param localVariables The local variables hash map.
     * @param left The expression on the left of the bigger-equals sign.
     * @param right The expression in the right of the bigger-equals sign.
     */
