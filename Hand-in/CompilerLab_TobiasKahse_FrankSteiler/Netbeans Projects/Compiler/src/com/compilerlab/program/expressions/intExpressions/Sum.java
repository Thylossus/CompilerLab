...
import com.compilerlab.jasmin.IADD;
...
/**
 * This class represents the sum-expression "'left' + 'right'".
...
public class Sum extends IntExpression {
    ...
    /**
     * Default initialization of the sum-expression.
     * @param localVariables The local variables hash map.
     * @param left The expression on the left of the plus-sign.
     * @param right The expression on the right of the plus-sign.
     */
    public Sum(HashMap<String, Value> localVariables, Expression left, Expression right) 
    {
    ...
    public List<Command> compile() 
    {
        ...
        //Expression on the left of the plus-sign evaluated first
        commands.addAll(this.left.compile());
        //Expression on the right of the plus-sign evaluated second
        commands.addAll(this.right.compile());
        
        //Sumation of the result third
        commands.add(new IADD());
