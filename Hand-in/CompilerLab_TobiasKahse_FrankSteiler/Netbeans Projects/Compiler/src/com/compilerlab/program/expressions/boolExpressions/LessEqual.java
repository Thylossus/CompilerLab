...
/**
 * This class represents the  boolean expression less-equals: "'left' &lt;= 'right'".
...
public class LessEqual extends BoolExpression {
    ...
    /**
     * Default initialization of the less-equals-expression.
     * @param localVariables The local variables hash map.
     * @param left The expression on the left of the less-equals sign.
     * @param right The expression on the right of the less-equals sign.
     */
    public LessEqual(HashMap<String, Value> localVariables, Expression left, Expression right) 
    {
