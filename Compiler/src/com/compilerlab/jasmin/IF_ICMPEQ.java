...
/**
 * This class represents the assembly instruction for the "if cmpeq"-command. It checks whether the value on the top of the stack is the same as the next value on the stack. Go to the specified label in case of a successful comparison.
...
public class IF_ICMPEQ extends Command {
    ...
    /**
     * Default initialization of the assembly instruction for the "if cmpeq"-command.
