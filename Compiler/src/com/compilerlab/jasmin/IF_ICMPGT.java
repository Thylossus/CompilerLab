...
/**
 * This class represents the assembly instruction for the "if cmpgt"-command. It checks whether second uppermost value on the stack is greater than the first value on the stack. Go to the specified label in case of a successful comparison.
...
public class IF_ICMPGT extends Command {
    ...
    /**
     * Default initialization of the assembly instruction for the "if cmpgt"-command.
