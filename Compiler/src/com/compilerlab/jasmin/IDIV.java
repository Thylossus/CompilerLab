...
/**
 * This class represents the assembly instruction for the "idiv"-command. It divides the second uppermost value on the stack by the uppermost value and leaves the result on the stack.
