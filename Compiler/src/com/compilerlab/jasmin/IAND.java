...
/**
 * This class represents the assembly instruction for the "iand"-command. It computes the bitwise conjunction of the two uppermost values on the stack and pushes the result on the stack.
 * @author Tobias Kahse <tobias.kahse@outlook.com>
 * @author Frank Steiler <frank@steiler.eu>
 */
public class IAND extends Command {
