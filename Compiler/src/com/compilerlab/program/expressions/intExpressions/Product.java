...
/**
 * This class represents the multiplication-expression "'left' * 'right'".
...
public class Product extends IntExpression {
    ...
    /**
     * Default initialization of the multiplication-expression.
     * @param localVariables The local variables hash map.
     * @param left The expression on the left of the times-sign.
     * @param right The expression on the right of the times-sign.
     */
    ...
    public List<Command> compile() 
    {
        ...
        //Expression on the left of the times-sign evaluated first
        commands.addAll(this.left.compile());
        //Expression on the right of the times-sign evaluated second
        commands.addAll(this.right.compile());

        //Multiplication of the result third
