...
/**
 * This class represents the  boolean expression bigger-than: "'left' > 'right'".
...
public class GreaterThan extends BoolExpression {
    ...
    /**
     * Default initialization of the bigger-than-expression.
     * @param localVariables The local variables hash map.
     * @param left The expression on the left of the bigger-than sign.
     * @param right The expression in the right of the bigger-than sign.
     */
