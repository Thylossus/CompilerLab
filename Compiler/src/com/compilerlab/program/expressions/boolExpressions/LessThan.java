...
/**
 * This class represents the  boolean expression less-than: "'left' &lt; 'right'".
...
public class LessThan extends BoolExpression {
    ...
    /**
     * Default initialization of the less-than-expression.
     * @param localVariables The local variables hash map.
     * @param left The expression on the left of the less-than sign.
     * @param right  The expression on the right of the less-than sign.
     */
    ...
    public List<Command> compile() 
    {
        ...
        IF_ICMPLT cmdIfIcmplt = new IF_ICMPLT(cmdLabelTrue.getLabel());
        ...
        //Checks if left value is less than right value, if true jump to true label
        commands.add(cmdIfIcmplt);
