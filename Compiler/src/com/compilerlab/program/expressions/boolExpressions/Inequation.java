...
/**
 * This class represents the  boolean expression inequals: "'left' != 'right'".
...
public class Inequation extends BoolExpression {
    ...
    /**
     * Default initialization of the inequals-expression.
     * @param localVariables The local variables hash map.
     * @param left The expression on the left of the inequals sign.
     * @param right The expression in the right of the inequals sign.
     */
    ...
    public List<Command> compile() 
    {
        ...
        IF_ICMPNE cmdIfIcmpne = new IF_ICMPNE(cmdLabelTrue.getLabel());
